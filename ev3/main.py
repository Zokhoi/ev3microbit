...
numbytearray=[
    ...
    bytearray([0x0C,0x12,0x04,0x08,0x1F]),
    bytearray([0x0E,0x02,0x0E,0x02,0x0E]),
    bytearray([0x14,0x14,0x1E,0x04,0x04]),
    bytearray([0x0E,0x08,0x0E,0x01,0x0E]),
    bytearray([0x06,0x08,0x1E,0x11,0x0E]),
    bytearray([0x0F,0x02,0x04,0x04,0x08]),
    bytearray([0x0E,0x11,0x0E,0x11,0x0E]),
    bytearray([0x0E,0x11,0x0E,0x02,0x02]),
]
